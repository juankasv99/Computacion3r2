...
{
	MyAssert(&t.m_pGraph != NULL, AssertTrackSenseGraf);
	MyAssert(&t != NULL, AssertNULL);
	MyAssert(this != NULL, AssertNULL);
	MyAssert(this->m_pGraph != NULL, AssertNULL);
	MyAssert(t.m_pGraph != NULL, AssertTrackSenseGraf);
	MyAssert(&(this->m_pGraph) != &(t.m_pGraph), AssertGrafsDiferents);
	//MyAssert(t.GetNEdges() != NULL, AssertNULL);
...
{
	MyAssert(&t.m_pGraph != NULL, AssertTrackSenseGraf);
	MyAssert(&t != NULL, AssertTrackSenseGraf);
	MyAssert(this != NULL, AssertNULL);
	MyAssert(this->m_pGraph != NULL, AssertNULL);
	MyAssert(t.m_pGraph != NULL, AssertTrackSenseGraf);
	MyAssert(this->m_pGraph == t.m_pGraph, AssertGrafsDiferents);
